...
from PyQt5.QtCore import Qt, QThread, pyqtSignal, QPropertyAnimation #추가3 signal #추가5  QPropertyAnimation 자연스러운 효과
#추가2
import pybithumb
#추가3
import time
...
class OrderbookWidget(QWidget):
    ...
    def updateData(self, data):
        ...
        for i, v in enumerate(data['asks'][::-1]):
            ...
            # item_2.setValue(tradingAskValues[i]) #추가5 이동
            #추가5
        ...
        for i, v in enumerate(data['bids']):
            ...
            # item_2.setValue(tradingBidValues[i]) #추가5 이동
            #추가5
